<div>
    <flux:modal name="edit-profile" class="md:w-1000" wire:model="showModal">

        <form wire:submit.prevent="save" class="space-y-6 p-6 rounded-lg">
            <div>
            ...
            <div>
                ...
                <div class="flex gap-2">
                    <input type="number" step="0.01" wire:model.defer="precio_cantidad"
                        class="flex-1 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md p-2 text-gray-900 dark:text-gray-100 focus:border-blue-500 focus:ring-blue-500"
                        placeholder="Ej: 1.5">
