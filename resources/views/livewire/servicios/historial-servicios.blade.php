<div class="py-6">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
        ...
        <!-- Filtros -->
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6 mb-6 border border-blue-400 dark:border-blue-400 ">
        ...
        <div class="border border-blue-400 dark:border-blue-400 bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
